...
import { AppBar, Tab, Tabs,Box, Toolbar, Typography,styled, InputBase, Badge ,Avatar,MenuItem,Menu,Divider,ListItemIcon} from '@mui/material'
      ...
      <AppBar  sx={{background:'#00303F',position:'fixed'}}>
        <ToolBar>
          ...
          {/* {
            ...
            <> */}
          <Icons>
            <SearchIcon onClick={()=>{navigate('/user')}}/>
