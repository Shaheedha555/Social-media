...
function RegisterForm() {
  ...
  useEffect(() => {
    axios.post("/searchUsername", { username: data.username }).then((res) => {
  ...
  const msgs = [
    "  4 to 23 characters.Must begin with a letter.",
      ...
      <div>
        <form onSubmit={onSubmit} action="">
          ...
          <div className="user-details">
            ...
            <Input
              msgClass={
                usernameFocus && data.username && !validUsername
                  ? "instructions"
                  : "offscreen"
              }
              msg={msgs[1]}
            ...
            <Input
              msgClass={
                contactFocus && data.contact && !validContact
                  ? "instructions"
                  : "offscreen"
              }
              msg={msgs[5]}
            ...
            <Input
              msgClass={
                pwdFocus && data.password && !validPwd
                  ? "instructions"
                  : "offscreen"
              }
              msg={msgs[3]}
            ...
            <Input
              msgClass={
                matchFocus && data.matchPwd && !validMatch
                  ? "instructions"
                  : "offscreen"
              }
              msg={msgs[4]}
