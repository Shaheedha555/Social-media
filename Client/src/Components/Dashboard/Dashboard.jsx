...
//               {/* <TableCell align="right">{user.activeStatus}</TableCell> */}
//             </TableRow>
//           ))}
//         </TableBody>
//       </Table>
...
export default function EnhancedTable() {
  ...
  const blockUser = (id) => {
    setBlock(true);
    axios.post("/admin/blockUser", { id }).then((data) => {
      console.log(data.data.message);
    });
  };
  useEffect(() => {
    axios.post("/admin/getAllUsers", {}).then((data) => {
      console.log(data.data);
      setUsers(data.data.users);
    });
  }, [block]);
